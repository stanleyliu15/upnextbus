...
export const getNearestAgencyIdAsync = createAsyncAction(
  "@nextbus/GET_NEAREST_AGENCY_ID_REQUEST",
  "@nextbus/GET_NEAREST_AGENCY_ID_SUCCESS",
  "@nextbus/GET_NEAREST_AGENCY_ID_FAILURE"
)<void, string, Error>();
